...
#define SWIGTYPE_p_namespace swig_types[2]
...
SWIGINTERN int Swig_var_std_set(PyObject *_val) {
  {
    ...
    if (!argp) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""std""' of type '""namespace""'");
    } else {
      std = *((namespace *)(argp));
    }
  }
...
SWIGINTERN int Swig_var_Printer_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_class,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""Printer""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""Printer""' of type '""class""'");
    } else {
      Printer = *((class *)(argp));
    }
  }
...
SWIGINTERN PyObject *Swig_var_Printer_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&Printer), SWIGTYPE_p_class,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_CLI_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_class,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""CLI""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in variable '""CLI""' of type '""class""'");
    } else {
      CLI = *((class *)(argp));
    }
  }
...
SWIGINTERN PyObject *Swig_var_CLI_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&CLI), SWIGTYPE_p_class,  0 );
  return pyobj;
}
...
# endif
  ...
  SWIG_addvarlink(globals, "Printer", Swig_var_Printer_get, Swig_var_Printer_set);
  SWIG_addvarlink(globals, "CLI", Swig_var_CLI_get, Swig_var_CLI_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
