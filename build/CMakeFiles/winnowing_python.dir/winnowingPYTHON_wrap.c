...
/*-----------------------------------------------
              @(target):= _winnowing_python.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__winnowing_python

#else
#  define SWIG_init    init_winnowing_python

#endif
#define SWIG_name    "_winnowing_python"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_winnowing(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "winnowing", 4, 4, swig_obj)) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(swig_obj[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "winnowing" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = (char *)(buf1);
  if (!(SWIG_IsOK((res2 = SWIG_ConvertPtr(swig_obj[1],SWIG_as_voidptrptr(&arg2),SWIGTYPE_p_unsigned_int,0))))) {
    unsigned int val; 
    int ecode = SWIG_AsVal_unsigned_SS_int(swig_obj[1], &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "winnowing" "', argument " "2"" of type '" "uint32_t""'");
    }
    temp2 = (uint32_t)(val);
    arg2 = &temp2;
    res2 = SWIG_AddTmpMask(ecode);
  }
  if (!(SWIG_IsOK((res3 = SWIG_ConvertPtr(swig_obj[2],SWIG_as_voidptrptr(&arg3),SWIGTYPE_p_unsigned_int,0))))) {
    unsigned int val; 
    int ecode = SWIG_AsVal_unsigned_SS_int(swig_obj[2], &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "winnowing" "', argument " "3"" of type '" "uint32_t""'");
    }
    temp3 = (uint32_t)(val);
    arg3 = &temp3;
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "winnowing" "', argument " "4"" of type '" "uint32_t""'");
  } 
  arg4 = (uint32_t)(val4);
  result = (uint32_t)winnowing((char const *)arg1,arg2,arg3,arg4);
...
static PyMethodDef SwigMethods[] = {
	 { "winnowing", _wrap_winnowing, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
